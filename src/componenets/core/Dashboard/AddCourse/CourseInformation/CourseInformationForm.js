...
export default function CourseInformationForm() {
  ...
  return (
    <form
      ...
      className="space-y-8 mx-14 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6"
    >
      {/* Course Title */}
      ...
      <div className="flex flex-col space-y-2">
        ...
        <div className="relative">
          <input
            ...
            className="form-style  !pl-12 w-full border rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5 "
          />
