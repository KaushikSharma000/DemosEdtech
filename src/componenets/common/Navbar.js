...
const NavBar = ({ setProgress }) => {
    ...
    return (
        <div className={` flex sm:relative bg-richblack-900 w-screen relative z-50 h-14 
            ...
            <div className='flex w-11/12 max-w-maxContent items-center justify-between '>
                ...
                <nav>
                    <ul className=' flex-row gap-x-6 text-richblack-25 gap-5 hidden md:flex'>
                        ...
                        <form onSubmit={handelSearch} className='lg:flex -mt-1 items-center relative sm:hidden md:hidden'>
